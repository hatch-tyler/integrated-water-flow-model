...
echo CHARACTER(LEN=40),PARAMETER :: f_cTag    = '%tag%'      > %mypath%IWFMKernelVersion.fi
echo CHARACTER(LEN=40),PARAMETER :: f_cBranch = '%branch%'  >> %mypath%IWFMKernelVersion.fi
echo CHARACTER(LEN=40),PARAMETER :: f_cHash   = '%sha1%'    >> %mypath%IWFMKernelVersion.fi
