...
! ******************************************************************
  ...
  CONTAINS
    ...
    PROCEDURE(Abstract_StrmGWConnector_Simulate_JFNK),PASS,DEFERRED                   :: Simulate_JFNK 
  ...
  ABSTRACT INTERFACE
      ...
      SUBROUTINE Abstract_StrmGWConnector_Simulate_JFNK(Connector,iNNodes,rGWHeads,rStrmHeads,rAvailableFlows,lUpdateStrmEqns,Matrix,WetPerimeterFunction,rMaxElevs)
        IMPORT                                          :: BaseStrmGWConnectorType,AbstractFunctionType,MatrixType
        CLASS(BaseStrmGWConnectorType)                  :: Connector
        INTEGER,INTENT(IN)                              :: iNNodes
        REAL(8),INTENT(IN)                              :: rGWHeads(:),rStrmHeads(:),rAvailableFlows(:)
        ...
        CLASS(AbstractFunctionType),OPTIONAL,INTENT(IN) :: WetPerimeterFunction(:)                     
        REAL(8),OPTIONAL,INTENT(IN)                     :: rMaxElevs(:)
      END SUBROUTINE Abstract_StrmGWConnector_Simulate_JFNK
