...
! ******************************************************************
  ...
  CONTAINS
      ...
      PROCEDURE,PASS :: Simulate_JFNK                   => StrmGWConnector_v41_Simulate_JFNK
...
CONTAINS
  ...
  ! -------------------------------------------------------------
  SUBROUTINE StrmGWConnector_v41_SetModuleLogger(Logger)
    TYPE(MessageLoggerType), TARGET, INTENT(IN) :: Logger
    ModuleLogger => Logger
  END SUBROUTINE StrmGWConnector_v41_SetModuleLogger
  ...
  ! -------------------------------------------------------------
  SUBROUTINE StrmGWConnector_v41_Simulate_JFNK(Connector,iNNodes,rGWHeads,rStrmHeads,rAvailableFlows,lUpdateStrmEqns,Matrix,WetPerimeterFunction,rMaxElevs)
    CLASS(StrmGWConnector_v41_Type)                 :: Connector
    INTEGER,INTENT(IN)                              :: iNNodes
    REAL(8),INTENT(IN)                              :: rGWHeads(:),rStrmHeads(:),rAvailableFlows(:)
    LOGICAL,INTENT(IN)                              :: lUpdateStrmEqns
    ...
    REAL(8)           :: rUnitConductance,rUpdateRHS(2),rGWHead,rStrmGWFlow,rFractionForGW,  &
                         rWetPerimeter,rHeadDiff,rConductance
    INTEGER,PARAMETER :: iCompIDs(2) = [f_iStrmComp , f_iGWComp]
  ...
  END SUBROUTINE StrmGWConnector_v41_Simulate_JFNK
