...
! ******************************************************************
  ...
  ! --- GET SOLVER
  ! -------------------------------------------------------------
  FUNCTION GetSolver(Matrix) RESULT(iSolver)
    CLASS(MatrixType),INTENT(IN) :: Matrix
    INTEGER                      :: iSolver
    
    iSolver = Matrix%Solver%iSolver
  ...
  ! -------------------------------------------------------------
  ! --- GET THE ENTIRE RHS VECTOR
  ! -------------------------------------------------------------
  SUBROUTINE GetRHSVector(Matrix,RHS)
    CLASS(MatrixType),INTENT(IN) :: Matrix
...
!       
  ...
  ! --- RESET RHS TO ZERO
  ! -------------------------------------------------------------
  SUBROUTINE ResetRHSToZero(Matrix)
    CLASS(MatrixType) :: Matrix
    
    Matrix%RHS   = 0.0
  
  END SUBROUTINE ResetRHSToZero
