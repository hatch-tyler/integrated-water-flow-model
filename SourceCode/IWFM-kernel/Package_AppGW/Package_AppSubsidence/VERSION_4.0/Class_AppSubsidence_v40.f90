...
! ******************************************************************
  ...
  CONTAINS
      ...
      PROCEDURE,PASS :: ComputeRHS                      => AppSubsidence_v40_ComputeRHS
...
! ******************************************************************
  ...
  SUBROUTINE ReadSubsidenceICData_OpenFile(cICFileName,iGWNodeIDs,InterbedThick,PreCompactHead,iStat)
    ...
    !Local variables
    CHARACTER(LEN=ModNameLen+29) :: ThisProcedure = ModName // 'ReadSubsidenceICData_OpenFile'
  ...
  SUBROUTINE ReadSubsidenceICData_FromOpenedFile(ICFile,iGWNodeIDs,InterbedThick,PreCompactHead,iStat)
    ...
    !Local variables
    CHARACTER(LEN=ModNameLen+35) :: ThisProcedure = ModName // 'ReadSubsidenceICData_FromOpenedFile'
    INTEGER                      :: ID,indxNode,NLayers,NNodes,iNode
    REAL(8)                      :: rFact,rDummyArray(1+2*SIZE(InterbedThick,DIM=2))
    LOGICAL                      :: lProcessed(SIZE(iGWNodeIDs))
...
! ******************************************************************
  ...
  ! -------------------------------------------------------------
  SUBROUTINE AppSubsidence_v40_ComputeRHS(AppSubsidence,Stratigraphy,GWHead,GWHead_P,rStorage,Matrix)
    CLASS(AppSubsidence_v40_Type)     :: AppSubsidence
    TYPE(StratigraphyType),INTENT(IN) :: Stratigraphy
    ...
    !Local variables
    INTEGER           :: indxLayer,indxNode,iBase,NNodes,NLayers,iGWNode
    REAL(8)           :: rGWHead,rGWHead_P,Storativ,rInterbedThick,PreCompactHead,rTopElev,rBottomElev,  &
                         ElasticSC,InelasticSC,rUpdateRHS(SIZE(GWHead)),rScaleFactor,   &
                         rFlow,rStor,rStorPos
  ...
  END SUBROUTINE AppSubsidence_v40_ComputeRHS
