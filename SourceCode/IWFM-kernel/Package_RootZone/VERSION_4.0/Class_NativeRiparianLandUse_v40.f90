...
! ******************************************************************
  ...
  ! -------------------------------------------------------------
  PRIVATE
  PUBLIC :: NativeRiparianLandUse_v40_Type
  PUBLIC :: NativeRiparianLandUsev40_SetModuleLogger
  
  
  ! -------------------------------------------------------------
  ! --- NATIVE/RIPARIAN LAND DATA TYPE
  ! -------------------------------------------------------------
  TYPE,EXTENDS(GenericLandUseType) :: NativeRiparian_v40_Type
  END TYPE NativeRiparian_v40_Type
  ...
  END TYPE NativeRiparianLandUse_v40_Type
  ...
  CHARACTER(LEN=ModNameLen),PARAMETER :: ModName    = 'Class_NativeRiparianLandUse_v40::'
...
CONTAINS
  ...
  ! --- SET MODULE LOGGER
  ! -------------------------------------------------------------
  SUBROUTINE NativeRiparianLandUsev40_SetModuleLogger(Logger)
    TYPE(MessageLoggerType), TARGET, INTENT(IN) :: Logger
    ModuleLogger => Logger
  END SUBROUTINE NativeRiparianLandUsev40_SetModuleLogger
...
! ******************************************************************
  ...
  SUBROUTINE Kill(NVRVLand)
    ...
    !Local variables
    INTEGER                              :: ErrorCode
    TYPE(NativeRiparianLandUse_v40_Type) :: Dummy
    ...
    SELECT TYPE (NVRVLand)
        TYPE IS (NativeRiparianLandUse_v40_Type)
            NVRVLand = Dummy
    END SELECT
...
! ******************************************************************
  ...
  SUBROUTINE PrintRestartData(NVRVLand,OutFile)
    CLASS(NativeRiparianLandUse_v40_Type),INTENT(IN) :: NVRVLand
