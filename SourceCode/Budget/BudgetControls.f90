...
CONTAINS
  ...
  SUBROUTINE GetMainControlData(FileName,iStat)
    ...
    ELSE
      CALL Print_screen('Program: Budget',IWFMVersion)
    ...
    CALL MainControlFile%ReadData(ALine,iStat)  ;  IF(iStat .EQ. -1) RETURN  ;  UNITLTOU = ADJUSTL(StripTextUntilCharacter(ALine,f_cInlineCommentChar))
    CALL MainControlFile%ReadData(FACTAROU,iStat)  ;  IF(iStat .EQ. -1) RETURN
    CALL MainControlFile%ReadData(ALine,iStat)  ;  IF(iStat .EQ. -1) RETURN  ;  UNITAROU = ADJUSTL(StripTextUntilCharacter(ALine,f_cInlineCommentChar))
    CALL MainControlFile%ReadData(FACTVLOU,iStat)  ;  IF(iStat .EQ. -1) RETURN
    CALL MainControlFile%ReadData(ALine,iStat)  ;  IF(iStat .EQ. -1) RETURN  ;  UNITVLOU = ADJUSTL(StripTextUntilCharacter(ALine,f_cInlineCommentChar))
    ...
    ALine = ADJUSTL(StripTextUntilCharacter(ALine,f_cInlineCommentChar,Back=.TRUE.)) 
    ...
    DO indxBudget=1,NBudget
      ...
      CALL MainControlFile%ReadData(ALine,iStat)  ;  IF(iStat .EQ. -1) RETURN  ;  ALine  = ADJUSTL(StripTextUntilCharacter(ALine,f_cInlineCommentChar))  ;  CALL CleanSpecialCharacters(ALine)
